...
class Paginador {
    ...
    public function getView($link = false) {

        //$rutaView = APP . "view/_templates/paginacion.php";           // Habilitar paginación PHP
        $rutaView = APP . "view/_templates/paginacionAjax.php";         // Habilitar paginación AJAX
